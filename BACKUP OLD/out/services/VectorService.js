...
class VectorService {
     ...
     */
    vectorizeSnippet(snippet, forceInactive = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const analysisResult = yield this.phpAnalyzer.analyze(snippet.code);
     ...
     */
    searchSimilar(query, limit = 10, includeInactive = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
     ...
     */
    cleanupInactiveVectors(activeSnippetIds) {
        return __awaiter(this, void 0, void 0, function* () {
            let cleanedCount = 0;
    ...
    testVectorSearch(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield this.searchSimilar(query, 5);
